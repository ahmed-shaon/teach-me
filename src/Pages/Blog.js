        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 p-8 gap-4 text-gray-800'>
            <div className="max-w-xs rounded-md shadow-md dark:bg-gray-900  dark:text-gray-100">
                ...
                <div className="flex flex-col justify-between p-6 space-y-8">
                    ...
                    <button type="button" className="flex items-center justify-center w-full p-3 font-semibold tracking-wide rounded-md bg-violet-200 dark:bg-violet-400 dark:text-gray-900">Read more</button>
                </div>
            </div>
            <div className="max-w-xs rounded-md shadow-md dark:bg-gray-900 dark:text-gray-100">
                <img src="https://source.unsplash.com/random/300x300/?2" alt="" className="object-cover object-center w-full rounded-t-md h-72 dark:bg-gray-500" />
